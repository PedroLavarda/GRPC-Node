...
exports.CdsLoadBalancer = void 0;
exports.setup = setup;
...
class CdsLoadBalancer {
    constructor(channelControlHelper, credentials, options) {
        ...
        this.childBalancer = new load_balancer_xds_cluster_resolver_1.XdsClusterResolverChildPolicyHandler(channelControlHelper, credentials, options);
    }
